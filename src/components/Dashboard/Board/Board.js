...
function UsersBoard(props) {
    ...
    return (
        <>
            <div className="bg-sky-300 flex-grow grid grid-cols-1 md:grid-cols-6 py-3 px-5 mb-10 font-bold text-base md:items-center md:justify-items-center rounded-md">
                <div>
                    First Name
                </div>
            ...
            </div>
            {
                ...
                users.map(user => {
                    return <div key={user._id} className="bg-white border-2 border-sky-400 flex-grow grid grid-cols-1 md:grid-cols-6 py-3 px-5 mb-4 md:items-center md:justify-items-center rounded-md">
                        <div className="mb-1">
...
export function Board(props) {
    return (
        <div className="board bg-sky-100 rounded-2xl p-4">
            {
